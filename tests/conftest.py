...
def postgres_container() -> Generator[PostgresContainer, None, None]:
    """Поднимает PostgreSQL контейнер на время всей тестовой сессии.
...
def test_database_url(postgres_container: PostgresContainer) -> str:
    """Возвращает URL тестовой базы данных из контейнера.
...
async def setup_database(test_database_url: str) -> AsyncGenerator[None, None]:
